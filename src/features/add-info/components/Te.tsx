...
export default function AddInfoForm() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-tr from-pink-500 to-yellow-500">
      <form
        className="mx-auto flex w-full max-w-lg flex-col gap-6 rounded-3xl border border-white/20 bg-white/10 p-10 shadow-2xl backdrop-blur-2xl"
