  ...
  return (
    ...
    <section className="relative mb-10 flex h-[60vh] items-center justify-center bg-cover bg-center text-white">
      <div className="px-4 text-center">
        ...
        <button className="rounded-full bg-white px-6 py-2 font-semibold text-black transition hover:scale-105 hover:bg-[#ffc0d4]">
          <Link href="/popup/search">팝업스토어 둘러보기</Link>
        </button>
      </div>
    </section>
  );
